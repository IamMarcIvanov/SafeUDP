        ...
        while(True):
            ...
            try:
                ...
                if(len(self.missingPackets) == 0):
                    ...
                    self.udpSocket.sendto(Packet("", -1, rst = True).makePacket().encode(), (self.ip, self.port))
                    break
                else:
                    ...
                    self.udpSocket.sendto(Packet("",self.maxx,rst=True).makePacket().encode(), (self.ip,self.port))
                    #continue
            ...
            # Check for missing packets list
                ...
                # We have received the list of dropped packets in data.
                    ...
                    self.udpSocket.sendto(Packet("",self.maxx,rst=True).makePacket().encode(), address)
        ...
        while(True):
            ...
            if(message[0][6] == "1"):
                ...
                if hashlib.sha256(message[4].encode()).hexdigest() == message[2]:
                    ...
                    print("Packet", message[1], "found corrupted.Dropped it..!!")
